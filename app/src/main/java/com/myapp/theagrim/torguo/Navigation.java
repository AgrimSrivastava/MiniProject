...
public class Navigation extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double destinationLat=Double.parseDouble(getIntent().getStringExtra("Lattitude"));
        double destinationLng=Double.parseDouble(getIntent().getStringExtra("Longitude"));
//        origin=Point.fromLngLat(originLong,originLat);
        final Double srclattitude=28.6448;//Double.parseDouble(sharedPreferences.getString("Lattitude","0"));
        final Double srclongitude=77.2300;//Double.parseDouble(sharedPreferences.getString("Longitude","0"));
        ...
        NavigationRoute.builder(this)
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        ...
                        Toast.makeText(getApplicationContext(),"RouteFound",Toast.LENGTH_SHORT).show();
